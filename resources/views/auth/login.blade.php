...
<html lang="en">
	<head>
        ...
        <!-- Favicon -->
		<link rel="icon" href="{{ URL::asset('assets/img/13.jpg')}}" type="image/x-icon"/>
								...
								<div class="row">
									<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
										<div class="card-sigin">
											<div class="mb-5 d-flex"> <h1 class="main-logo1 mr-1 mr-0 my-auto tx-28">EY<span>AV</span>İ</h1><a href="#"><img src="{{ URL::asset('assets/img/13.jpg')}}" class="sign-favicon ht-40" alt="logo"></a></div>
											<div class="card-sigin">
